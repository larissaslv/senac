...
def fn_estado():
    ...
    print("3. listar")
    print("4. Apagar: ")
    print("0. Volta para o Menu Relações")
def fn_cidade():
    print("1. Inserir: ")
    print("2. Consultar: ")
    print("3. listar")
    ...
    if opcao == '1':
        ...
        while True:
            ...
            if opcao6 == '1':   Agenda.fn_calendario()
                ...
                fn_sub_agenda()
                opcao2 = input("Escolha uma opção: ")
                if opcao2 == '1': Agenda.fn_evento()
                elif opcao2 == '2': Agenda.fn_consultaevento()
        ...
        while True:
            ...
            if opcao7 == '1':
                ...
                while True:
                    fn_estado()
                    opcao2 = input("Escolha uma opção: ")
                    if opcao2 =='1': Relações.fn_ins_estado()
                    elif opcao2 == '2': Relações.fn_con_estado()
                    elif opcao2 == '3': Relações.fn_lis_estado()
                    elif opcao2 == '4': Relações.fn_del_estado()
                    elif opcao2 == '0': break
            elif opcao7 == '0': break
            elif opcao7 == '2':
                while True:
                    fn_cidade()
                    opcao2 = input("Escolha uma opção: ")
                    if opcao2=='1': Relações.fn_ins_cidade()
                    elif opcao2 == '2': Relações.fn_con_cidade()
                    elif opcao2 == '3': Relações.fn_lis_cidade()
                    elif opcao2 == '4': Relações.fn_del_cidade()
                    elif opcao2 == '0': break
            elif opcao7 == '0': break
            elif opcao7 == '3':
                while True:
                    fn_bairro()
                    opcao2 = input("Escolha uma opção: ")
                    if opcao2 == '1': Relações.fn_ins_bairro()
                    elif opcao2 == '0': break
            elif opcao7 == '0': break
    else:
